  ...
  return (
    <div className="flex gap-8 max-md:flex-row flex-col top-20 right-20 max-md:right-0 max-md:relative absolute justify-center">
      <a
        ...
        target="_blank"
        className="border hover:bg-[#0077B5] bg-[#0077B530] border-[#0077B5] px-2.5 py-2 rounded-md rotate-45"
      >
      ...
      <a
        ...
        target="_blank"
        className="border hover:bg-[#2b3137] bg-[#2b313730] border-[#2b3137] px-2.5 py-2 rounded-md rotate-45"
      >
      ...
      <a
        ...
        target="_blank"
        className="border hover:bg-[#ff0000] bg-[#ff000030] border-[#ff0000] px-2.5 py-2 rounded-md rotate-45"
      >
